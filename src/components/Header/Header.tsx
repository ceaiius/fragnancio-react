        ...
        <div className="flex justify-between items-center h-16 px-8">
          ...
          <div className="relative hidden md:flex w-[34vw] lg:w-[42vw] max-w-[704px]">
            ...
            <input type="text" placeholder="Search"
              className="h-10 rounded-3xl bg-black-button text-ellipsis border-2 border-black-border w-full px-12" />
          </div>

          <nav>
            <ul className="flex gap-4 items-center">
              <li>
                <button className="bg-black-border text-white px-4 py-1 rounded-xs font-bold hidden md:block">Sell now</button>
              </li>
              <li className='md:hidden'><img src={searchIcon} className="w-7 h-7" alt='search icon'/></li>
              <li><a href="#"><img src={inboxIcon} className='w-7 h-7' alt='inbox icon'/></a></li>
              <li><a href="#"><img src={heartIcon} className='w-7 h-7' alt='heart Icon'/></a></li>
              <li><a href="#"><img src={bagIcon} className='w-7 h-7' alt='bag Icon'/></a></li>
              <li className='hidden md:block'><a href="#">Profile</a></li>
            </ul>
          </nav>
        </div>
        <hr className='bg-light-border border-0 h-px' />
